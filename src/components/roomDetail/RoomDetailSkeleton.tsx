		...
		<div>
			...
			<div role="status" className="animate-pulse w-full mt-[48px] ">
				...
				<div className="w-full ">
					<div className="h-3 bg-gray rounded-full dark:bg-gray-700 w-36 mt-3"></div>
					<div className="h-4 bg-gray rounded-full dark:bg-gray-700 w-44 mt-3"></div>
					<div className="h-4 bg-gray rounded-full dark:bg-gray-700 w-44 mt-1.5"></div>
					<div className="h-4 bg-gray rounded-full dark:bg-gray-700 w-48 mt-5"></div>

					<div className="border border-borderGray p-4 rounded-lg mt-5 pb-5">
						<div>
							<div className="h-3 bg-gray rounded-full dark:bg-gray-700 w-36 mt-3"></div>
							<div className="h-3 bg-gray rounded-full dark:bg-gray-700 w-44 mt-3"></div>
						</div>
