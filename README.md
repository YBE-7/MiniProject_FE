...
<summary>양재혁</summary>
  ...
  #### 좋았던 점
> 1. 백엔드와의 협업으로 서버와 클라이언트 구조를 이해할 수 있어 좋았습니다.
> 2. 리액트 쿼리에 능숙해 질 수 있어서 좋았습니다.
> 3. Jira를 사용하여 agile한 팀 프로젝트를 진행할 수 있어 유익했습니다.
#### 아쉬운 점
> 1. 다들 열심히 잘 해주셨지만, 인원 부족으로 추가 기능을 생각하지 못했던 점이 아쉽습니다.
> 2. HTTP 메서드 테스트 외 다른 테스트를 진행하지 못했던 부분이 아쉽습니다.
> 3. 리프래시 토큰으로 핸들링 하지 못한 부분이 아쉽습니다.
</details>
<details>
<summary>정효주</summary>
